...
<body>
    ...
    <form method="POST" action=<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>>
        <div class="mailcont">
            ...
            <input type="text " id='email' placeholder="Valid Email Address" size='100' name='email'>
        ...
        <div class="fistnamecont">
            ...
            <br><br>
            <input type="text " id='fname' placeholder="First Name" size='100' name="fname">
        ...
        <div class="lastnamecont">
            ...
            <br><br>
            <input type="text " id='lname' placeholder="Last Name" name="lname" size='100'>
        ...
        <div class="contactcont">
            ...
            <br><br>
            <input type="number" id="number" placeholder="Phone Number" name="number" size='100'>
        ...
        <div class="pswcont">
            ...
            <br><br>
            <input type="password" id='password' placeholder="New Password" name="psw" size='100'>
        ...
        <br><br>
        <div class="btncont">
            <button type="submit" onclick="user_registration()" class="signup"> Signup</button>
